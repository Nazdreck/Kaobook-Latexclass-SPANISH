...
\begin{itemize}
    ...
    \item \textbf{Kaobook-Latexclass-SPANISH.pdf} Documento de ejemplo. Este documento.
\end{itemize}
...
\begin{marginfigure}[0cm]
	\includegraphics{monalisa}
	\caption[La Mona Lisa, una vez más.]{La Mona Lisa, una vez más.\\ 
...
En este parrafo se ilustra cómo se ven distintos elementos del backmatter, como las referencias bibliograficas: \sidecite{Ardlie2015,Visscher2008,Gusev2018}; elementos del glosario: \acrfull{fpsLabel}, \gls{computer}, \acrshort{fpsLabel}. Y usando el comando \Command{index}, podés indicarle al indice dónde está una palabra de interés. \index{Índice}.
